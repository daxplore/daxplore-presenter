...
/**
 * <p> Implementation of the {@link java.util.regex.Pattern} class with a
 * wrapper aroung the Javascript <a href=
 ...
 * expressions must be expected. </p> <p> Please note that neither the
 * {@link java.util.regex.Pattern#compile(String)} method nor {@link Matcher}
 * instances are supported. For the later, consider using
 * {@link Pattern#match(String)}. </p>
 * 
...
public class Pattern {
	...
	private native void _match(String text, List<?> matches)/*-{
		var regExp = this.@org.daxplore.presenter.chart.Pattern::regExp;
	...
	/**
	 * Construct a new pattern to match against.
	 * 
	 * @param pattern
	 *            Regular expression
	 */
